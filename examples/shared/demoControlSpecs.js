...
export const DEMO_CONTROL_SPECS = [
  ...
  { key: 'relief', label: 'Relief', type: 'select', options: [['carve', 'carve (peaked)'], ['plateau', 'plateau']] },
  ...
  { key: 'reliefRange', label: 'Carve range × falloff', type: 'range', min: 1, max: 12, step: 0.5 },
