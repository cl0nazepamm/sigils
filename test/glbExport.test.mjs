...
import { makeStrokeRecord } from '../examples/shared/strokeSession.js';
...
const strokes = [makeStrokeRecord([[0, 0], [0.6, 0.1], [0.9, 0.4]], state)];
...
assert.ok(glb.byteLength > 100, 'binary GLB has mesh payload');
